...
public class TesteClienteMediator extends TesteAbstrato {
	...
	public void testeValidarCliente06() {
		...
		assertionsResultadoMediatorValidado(res);
		cliente = new Cliente(CPF_VALIDO, "JOSILDO SA", new Contato("js@eee.com.au", STR_VAZIA, false),
				LocalDate.now().minusDays(10));
		res = mediator.validar(cliente);
		assertionsResultadoMediatorValidado(res);
	}
	...
	public void testeAlterarClienteSucesso() {
		...
		Cliente clienteAlt = new Cliente(CNPJ_VALIDO, "JOPA11 LTDA",
				new Contato("jopa11@vvv.com.fr", "(31)959660341", false), LocalDate.now().minusDays(22));
